...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand " style="font-family: 'Delius Swash Caps'">Shopping Zone</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#men" class="dropdown-item">Men</a>
                                   <a href="products.php#woman" class="dropdown-item">Woman</a>
                                   <a href="products.php#shoes" class="dropdown-item">Shoes</a>
                                   <a href="products.php#watches" class="dropdown-item">Watches</a>
                                   <a href="products.php#headphones" class="dropdown-item">Headphones</a>
                               </div>
